...
namespace CherryCitySoftware.MedicalOffice.Context
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
       ...
       //  public DbSet<CherryCitySoftware.MedicalOffice.Models.DocFile> DocFiles { get; set; }

       public DbSet<DocFile> DocFiles { get; set; }

       //public DbSet<CherryCitySoftware.MedicalOffice.Models.ResourceLink> ResourceLinks { get; set; }
