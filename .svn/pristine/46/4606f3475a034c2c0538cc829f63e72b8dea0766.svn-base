namespace CherryCitySoftware.MedicalOffice.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Recepient_Id = c.String(maxLength: 128),
                        Sender_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.ApplicationUser_Id)
                .ForeignKey("dbo.AspNetUsers", t => t.Recepient_Id)
                ...
                c => new
                    {
                        ...
                        Forcechangpassword = c.Boolean(nullable: false),
                        FirstName = c.String(),
                        MiddleName = c.String(),
                        LastName = c.String(),
                        Address = c.String(),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Long(nullable: false, identity: true),
                        Policy = c.String(nullable: false, maxLength: 4000),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PatientPolicies", "Patient_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.PatientPolicies", new[] { "Patient_Id" });
